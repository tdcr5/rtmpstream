...
class VideoEncoder {
    ...
    constructor(width, height, vtype) {
        ...
        let encParams = {
            ...
            priv_data: { preset: 'medium', profile:'baseline', level:'3.1', tune:'zerolatency'},
            thread_count:4
...
module.exports = {VideoDecoder, AudioDecoder, VideoEncoder, AudioEncoder, YUVConverter, RGBConvert, PCM_FLTPConverter, PCM_SignedConverter};